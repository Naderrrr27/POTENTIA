...
export const Try = () => {
  ...
  const changeColor = () => {
    setColor(1 + color);
    document.getElementById('ana2').style.transition = "background-color 0.5s";
    document.getElementById('ana2').style.backgroundColor = "red";
  }
  //
  const [colorf, setColorf] = useState(0);
  const changeColorf = () => {
    setColorf(1 + colorf);
    document.getElementById('ana2').style.backgroundColor = "#3d5f00";
  }
    ...
    <div className="servoParent" style={mm.servoParent}>
      <div className="servoChild1" style={mystyle2}>
        <div id="childHead" style={mystyle3} >
          <div className="ii" style={mm.ii}>Jambalaya </div>
          <div className="i2" style={mm.i2}>$50</div>
        </div>
        ...
        <button className="btn" type="submit" style={mm.btn} id='ana2' onClick={changeColor} onDoubleClick={changeColorf}>BUY NOW</button>
      </div>
      <div className="servoChild2" style={{ flex: "1", marginLeft: "20px", paddingLeft: "30px" }}>
        <img src="/images/service3.png" alt="" width="220px" className='imk' style={mm.imk} />
      </div>
    </div>
